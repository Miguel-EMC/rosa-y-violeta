            ...
            changes    : [
                ...
                },
                {
                    ...
                    list: [
                        ...
                        '(apps/clients) Small adjustments for better consistency',
            ...
            changes    : [
                ...
                },
                {
                    ...
                    list: [
                        ...
                        '(apps/clients) Added confirmation to the "Delete contact" action using FuseConfirmationService',
            ...
            changes    : [
                ...
                },
                {
                    ...
                    list: [
                        ...
                        '(apps/clients) Explicitly define the overlay position strategy properties',
            ...
            changes    : [
                ...
                },
                {
                    ...
                    list: [
                        ...
                        '(apps/clients) Tweaked the hover color on contact list for better consistency',
        ...
        // v12.1.0
        {
            ...
            changes    : [
                ...
                },
                {
                    type: 'Fixed',
                    list: [
                        '(apps/clients) Clicking on the checkbox on Tag select panel acts weird',
                    ],
                },
            ],
        },
